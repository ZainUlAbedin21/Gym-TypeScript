...
>
  ...
  <p className="my-5">
Lorem ipsum dolor sit amet consectetur adipisicing elit. Non dolor quo vitae, assumenda itaque illo molestias dicta ex consequatur eum pariatur dolorem, voluptatem sed iusto officia aspernatur nobis aut quos!
  </p>
</motion.div>
{/*FORM */}
...
placeholder="MESSAGE"
  ...
  <button type="submit"
  className="mt-5 rounded-lg bg-secondary-500px-20 py-3 transition duration-500 hover:text-white"
  >
    SUMBIT
  </button>
